...
function openMemberDetailsModal(memberId) {
    ...
    // Get nonce from localized script or generate fresh one
    const nonce = (typeof jgkAjax !== 'undefined' && jgkAjax.nonce) ? jgkAjax.nonce : '<?php echo wp_create_nonce('jgk_get_member_details'); ?>';
    
    console.log('JGK Modal Debug - Nonce:', nonce);
